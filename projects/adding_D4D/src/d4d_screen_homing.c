...
D4D_DECLARE_STD_RGRAPH_BEGIN(scrHoming_graph, "ECG (Prueba)", GRAPH_POSX, GRAPH_POSY, GRAPH_SIZEX, GRAPH_SIZEY, 8, 4, 2, 20, FONT_ARIAL7, FONT_ARIAL7)
...
static void ScreenHoming_OnMain()
{
  if(iniciar)
  {
    ...
    if(flag100ms)
    {
      ...
      D4D_GraphAddTracesData(&scrHoming_graph, pDummyMusic);
      pDummyMusic += 1;
