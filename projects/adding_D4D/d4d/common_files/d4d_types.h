 ...
 */
  ...
  #define  D4D_LPC1769    100 //agregada. 100 no significa nada. todavia no se que significa los numeros de arriba
/**@}*/
...
*******************************************************************************/
  ...
  typedef Word D4D_INDEX;
  typedef sWord D4D_INDEX_DELTA;
#elif (D4D_MCU_TYPE == D4D_MCF51) || (D4D_MCU_TYPE == D4D_MCF52) || (D4D_MCU_TYPE == D4D_MPC51) || (D4D_MCU_TYPE == D4D_MK)|| (D4D_MCU_TYPE == D4D_LPC1769)
