...
#include "../low_level_drivers/LCD/lcd_controllers_drivers/sdd1963/d4dlcd_ssd1963.c"
#include "../low_level_drivers/touch_screen/touch_screen_drivers/ft5x06/d4dtch_ft5x06.c"
...
*
******************************************************************/
static D4D_ORIENTATION d4d_orientation = D4D_ORIENT_LANDSCAPE;  // ANTES ERA PORTRAIT JB
...
D4D_BOOL D4D_LCD_Init(void)
{
  ...
  D4D_LCD_SetOrientation(D4D_ORIENT_LANDSCAPE); // ERA PORTRAIT JB
